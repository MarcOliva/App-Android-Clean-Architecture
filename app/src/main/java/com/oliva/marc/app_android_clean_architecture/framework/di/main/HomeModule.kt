...
class HomeModule {
    @Provides
    //@PerFragment
    fun provideDatabaseSource(contactDao: DaoContact): ContactsDatabaseDataSource =
    ...
    @Provides
    //@PerFragment
    fun provideGetContactsUseCaseImpl(repository: ContactsRepository): GetContactsUseCase = GetContactsUseCaseImpl(AsyncSTransformer(), repository)
}